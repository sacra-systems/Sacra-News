    ...
    <div class="media-body">
      ...
      <div class="share-buttons">
        <div class="mail">
          ...
          class="mailImg" src="/files/live/sites/hlmartin/files/bootstrap/img/per-email-share-button.png" alt="Link zum Artikel per E-Mail versenden" width="87" height="20"/></a> 
        </div>
