                ...
                try {
                    ...
                    while (ni.hasNext()) {
                        ...
                        if (republishDate3 != null && now.compareTo(republishDate3) > 0 && (isRepublished3 == null || !isRepublished3)) {
                            node.getRealNode().setProperty("isRePublished3", true);
                            final Calendar cal = Calendar.getInstance();
                            cal.setTime(republishDate3);
                            node.getRealNode().setProperty("sortingDate", cal);
                            ...
                            node.getRealNode().setProperty("isRePublished2", true);
                            ...
                            node.getRealNode().setProperty("isRePublished1", true);
                            final Calendar cal = java.util.Calendar.getInstance();
